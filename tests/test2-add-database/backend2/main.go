...
import (
	"context" // Required by pgx for DB operations
	"encoding/json"
	"log"
	"net/http"
	"os"

	"github.com/jackc/pgx/v5"  // Go PostgreSQL driver
...
// db is a global variable holding the Postgres connection.
// Initialized in main() and reused by HTTP handlers.
var db *pgx.Conn
